  ...
  var options_ {
    ...
    data: {
      labels: ["{{$section->labels[0]}}"
        @if(isset($section->two)), "{{$section->labels[1]}}"
        @endif @if(isset($section->three)), "{{$section->labels[2]}}"
        @endif @if(isset($section->four)), "{{$section->labels[3]}}"
        @endif @if(isset($section->five)), "{{$section->labels[4]}}"
        @endif
      ],
      datasets: [{
        label: '',
        ...
        backgroundColor: [
          '{{$section->one_color}}',
          @if(isset($section->two))
          '{{$section->two_color}}', @endif
          @if(isset($section->three))
          '{{$section->three_color}}', @endif
          @if(isset($section->four))
          '{{$section->four_color}}', @endif
